...
##
# Utility script for creating a new CLICdp note directory from the template
# Christian Grefe (christian.grefe@cern.ch)
##

show_usage() {
  echo "Usage:"
  echo "    createNewCLICdpNote.sh [-h] [-p path] name"
  echo "Options:"
...
templateName=CLICdp_template.tex
...
echo "Created new CLICdp note directory $notePath"
